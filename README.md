...
- [Production Tracking Systems](#production-tracking-systems)
- [Hardware](#hardware)
- [Industry Education](#industry-education)
- [SAM/SMV Tools](#samsmv-tools)
...
- [TrackIT](https://www.3-tree.com/) — Brand-side vendor performance tracking from Triple Tree Solutions.
- [PROTRACKER](https://www.skylarksoft.com/) — Established Bangladesh-based production tracking by Skylark Soft.
- [WiMetrix](https://wimetrix.com/) — Pakistan-based AI + RFID production tracking.

### Enterprise Apparel ERP
- [WFX Smart Factory](https://www.worldfashionexchange.com/) — Enterprise apparel ERP.
- [Aptean Apparel](https://www.aptean.com/en-US/solutions/erp/products/apparel-erp) — Enterprise apparel with PLM integration.
- [Centric PLM](https://www.centricsoftware.com/) — Product lifecycle management for fashion.
...
### QR Scanners
- ESP32-CAM with custom firmware — $15-25 per scanner station, OV2640 camera.
- Cheap Android phones ($50 range) with multi-decoder fallback (jsQR + BarcodeDetector + ZXing).

### Biometric Attendance
- ZKTeco devices with ADMS protocol — well-supported by most factory ERPs.

### Print Servers
- Raspberry Pi 4 (8GB RAM) — handles edge caching, print queue, biometric integration.
- TSC TTP-244 / TTP-247 — common factory label printers (TSPL command set).
- Brother HL-L2300D — for A4 packing list printing.
...
- [Fibre2Fashion](https://www.fibre2fashion.com/) — Largest textile industry portal (India).
- [Apparel Resources](https://apparelresources.com/) — Apparel industry news and analysis.
- [TextileLearner](https://textilelearner.net/) — Educational portal (Bangladesh).
- [Just-Style](https://www.just-style.com/) — Global fashion industry news.

### Industry Associations
- [BGMEA Bangladesh](https://www.bgmea.com.bd/) — Bangladesh Garment Manufacturers and Exporters Association.
- [AEPC India](https://www.aepcindia.com/) — Apparel Export Promotion Council.
- [VITAS Vietnam](https://www.vietnamtextile.org.vn/) — Vietnam Textile and Apparel Association.
- [GMAC Cambodia](https://www.gmac-cambodia.org/) — Garment Manufacturers Association in Cambodia.
...
- [SewEasy](https://www.seweasy.com/) — PMTS-based SMV calculation.
...
To the extent possible under law, the curators have waived all copyright and related or neighboring rights to this work.
